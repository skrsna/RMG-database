...
entry(
    ...
    degeneracy=1.0,
    kinetics=ArrheniusEP(A=(648, 'cm^3/(mol*s)'), n=0, alpha=0, E0=(0, 'kcal/mol')),
    rank=1,
    shortDesc=u"""""",
    longDesc=
    u"""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=ArrheniusEP(A=(11880, 'cm^3/(mol*s)'), n=0, alpha=0, E0=(0, 'kcal/mol')),
    rank=1,
    shortDesc=u"""""",
    longDesc=
    u"""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=ArrheniusEP(A=(3240, 'cm^3/(mol*s)'), n=0, alpha=0, E0=(0, 'kcal/mol')),
    rank=1,
    shortDesc=u"""""",
    longDesc=
    u"""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=ArrheniusEP(A=(1080, 'cm^3/(mol*s)'), n=0, alpha=0, E0=(0, 'kcal/mol')),
    rank=1,
    shortDesc=u"""""",
    longDesc=
    u"""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=ArrheniusEP(A=(216, 'cm^3/(mol*s)'), n=0, alpha=0, E0=(0, 'kcal/mol')),
    rank=1,
    shortDesc=u"""""",
    longDesc=
    u"""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=ArrheniusEP(A=(32, 'cm^3/(mol*s)'), n=0, alpha=0, E0=(0, 'kcal/mol')),
    rank=1,
    shortDesc=u"""""",
    longDesc=
    u"""
