...
entry(
    index = 124,
    label = "C1", # Single carbon atom with 4 bonds to either H or Val7
    group =
"""
1 *1 C u0 {2,S} {3,S} {4,S} {5,S}
2 *2 H u0 {1,S}
...
3    F1s u0 p3 c0 {5,S}
4    O u0 p2 c0 {6,D}
5    Cs u0 p0 c0 {1,S} {2,S} {3,S} {6,S}
6 *3 C u1 p0 c0 {4,D} {5,S}
""",
    kinetics = None,
)
