...
name = "3_amine_COH_HCN/groups"
shortDesc = u""
longDesc = u"""
This family describes a reaction between a tertiary amine with a COH branch and HCN (condensation),
producing a tertiary amine with a CC#N branch.
